...
export const MainPage: React.FC = () => {
    ...
    const exitButton = isBigMobile
        ? <Button icon={<ExitIcon className="exit__icon" style={{ fontSize: '14px'}}/>} className="button-icon-text exit__button">
        ...
        <>
            <Layout className="layout" style={{
                ...
                <Sider
                    ...
                    <MenuBlock isCollapsed={collapsed}
                               itemsData={menuItems}
                               isBigMobile={isBigMobile}/>
                    <div className={collapsed ? 'menu__exit exit exit--collapsed' : 'menu__exit exit'}>
                        {exitButton}
                    </div>
                ...
                <Layout style={{position: "relative"}} className="body-layout">
                    ...
                    <div className={collapsed ? "trigger__wrapper trigger__wrapper--collapsed" : "trigger__wrapper trigger__wrapper--uncollapsed"}
                    ...
                    <HeaderBlock isCollapsed={collapsed}
